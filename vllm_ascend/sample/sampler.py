...
class AscendTopKTopPSampler(TopKTopPSampler):
    ...
    def _apply_top_k_top_p(
        ...
        ) != AscendDeviceType._310P and p is not None and k is not None and 1 <= k_cpu.max() <= 1024:
    ...
    def forward_native(self, logits, sampling_metadata):
        ...
        return random_sample(probs, sampling_metadata.generators), logits_to_return
