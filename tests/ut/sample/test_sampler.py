...
from vllm_ascend.sample.sampler import AscendSampler, AscendSamplingMetadata, AscendTopKTopPSampler
...
class TestAscendTopKTopPSampler(TestBase):
    ...
    def test_npu_topk_topp_called_when_optimized(self, mock_npu_op,
        ...
        mock_npu_op.assert_called_once_with(logits, sampling_metadata.top_p, sampling_metadata.top_k)
